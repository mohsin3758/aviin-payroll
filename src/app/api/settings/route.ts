    ...
    if (existing) {
      company = await db.company.update({
        ...
        data: {
          ...
          ...(body.optionalHolidayQuota !== undefined && { optionalHolidayQuota: body.optionalHolidayQuota }),
      ...
      company = await db.company.create({
        data: {
          ...
          optionalHolidayQuota: body.optionalHolidayQuota ?? DEFAULT_COMPANY.optionalHolidayQuota,
